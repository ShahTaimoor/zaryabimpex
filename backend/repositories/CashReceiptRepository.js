...
class CashReceiptRepository extends BaseRepository {
  ...
  /**
   * Find cash receipts with pagination and filtering
   * @param {object} filter - Filter query
   * @param {object} options - Pagination and sorting options
   * @returns {Promise<{cashReceipts: Array, total: number, pagination: object}>}
   */
  async findWithPagination(filter = {}, options = {}) {
    ...
    const [cashReceipts, total] = await Promise.all([
      queryBuilder,
